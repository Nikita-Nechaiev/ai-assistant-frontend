      ...
      <div className='max-w-4xl mx-auto p-6'>
        <div className='bg-[#fbfbfb] p-6 rounded-lg shadow-md mb-8'>
          ...
          <p className='text-black text-lg leading-relaxed'>
            This project was created to <strong>showcase my skills</strong> to
            potential employers. It is a <strong>Full-Stack application</strong>{' '}
            built using
            <strong>
              {' '}
              PostgreSQL, Nest.js, WebSockets, Next.js, and React.js
            </strong>
            , with all the code written in <strong>TypeScript</strong>.
          </p>
          ...
          <ul className='list-disc pl-5 mt-2 space-y-2 text-black text-lg'>
            <li>
              <strong>AI-powered tools</strong> – Offers{' '}
              <strong>pre-configured AI functionalities</strong> like text
              analysis, translation into various languages, and AI-powered
              content generation, powered by the <strong>OpenAI API</strong>.
            </li>

            <li>
              <strong>Collaborative sessions</strong> – Users can{' '}
              <strong>create and participate</strong> in real-time collaboration
              sessions, working together on documents.
            </li>
            <li>
              <strong>User invitations & role management</strong> – Invite
              others, manage invitations, and assign roles. Users can be{' '}
              <strong>administrators, editors, or visitors</strong>, each with
              specific permissions.
            </li>
            <li>
              <strong>Rich-text editing</strong> – The document editor, powered
              by the <strong>Quill library</strong>, allows formatting and{' '}
              <strong>document export</strong> (currently available for English
              only).
            </li>
            <li>
              <strong>Version control</strong> – Every document update is saved,
              enabling users to navigate different versions and restore previous
              edits.
            </li>
            <li>
              <strong>AI integration within the editor</strong> – Select content
              within a document and apply
              <strong>one of nine AI functions</strong> to enhance, modify, or
              analyze the text.
            </li>
          </ul>
          ...
          <ul className='list-disc pl-5 mt-2 space-y-2 text-black text-lg'>
            ...
            <li>
              <strong>Custom Domain:</strong> A purchased domain is configured
              for both backend and frontend hosting.
            </li>
          </ul>

          <p className='text-black text-lg mt-4'>
            This project is designed to demonstrate my ability to build{' '}
            <strong>scalable, interactive, and AI-enhanced applications</strong>{' '}
            with a strong focus on real-time collaboration and intelligent
            automation.
          </p>
        </div>
        ...
        <div className='space-y-8'>
          ...
          <section>
            ...
            <p className='text-gray-600'>
              The central hub for accessing tools and features.
            </p>
          </section>
